...
app.post("/create-event", checkNotAuthenticated, isOrganisation, (req, res) => {
    ...
    let result = db.query(
        'INSERT INTO event (name, categories, org_id, start_date, end_date, location, description, img_url) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)',
        [name, keywords, req.user.id, begin, end, venue, description, image],
        (err, results) => {
            if(err){
                throw err;
            }
    ...
    res.render("create-event.ejs", {user: req.user, message: "Created!"});
})
